...
export default function ChatWindow(props: IProps) {
  ...
  useEffect(() => {
    ...
    ConsumeEffect(setIsMessageLoaded, setMessages, () => {
      return getMessages(channelNumber!);
    });
  }, [channelNumber]);
  //#endregion
                ...
                <div className={'message'}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MenuItem
                        onClick={() =>
                          downloadImage(CloseProfilePictureContext)
                        }
                      >
                        <div className="MenuItemWithIcon">
                          <SaveAltOutlined />
                  ...
                  {berichten.attachments &&
                    berichten.attachments.map((attachment, index) => (
                      ...
                      >
                        <img
                          src={`https://cdn.rdmraceapp.nl/attachments/${channelNumber}/${berichten.id}/${attachment.name}`}
                          width={200}
                          alt=""
                          className="Picture"
                        />
                        <Menu
                          ...
                          anchorPosition={
                            ImageContext !== null
                              ? {
                                  top: ImageContext!.mouseY,
                                  left: ImageContext!.mouseX,
                                }
                              : undefined
                          }
                        >
                          ...
                          <MenuItem
                            onClick={() => downloadImage(CloseImageContext)}
                          >
