      ...
      <div className="card">
        <Card style={{
          ...
          <div className="secondField">
            <TextField type="password" value={password} onChange={e=> setPassword(e.target.value)} color="primary"
              id="passwordInput" label="Password" variant="outlined" name='Password' />
          </div>
          <div>
