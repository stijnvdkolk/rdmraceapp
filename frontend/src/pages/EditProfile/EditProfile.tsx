...
export default function UserProfile() {
  ...
  const [anotherProfile, setAnotherProfile] = useState<Person | undefined>(
    undefined
  );
  ...
  useEffect(() => {
    ...
    if (aboutMe) {
      ...
      if (
        aboutMe !== meProfile?.aboutMe &&
        aboutMe !== anotherProfile?.aboutMe
      ) {
        ...
        >
          ...
          <div className="Head">
            <Button
              ...
              onClick={() =>
                personID ? history.push('/admin') : history.push('/chat')
              }
            >
          ...
          <div className="Tail">
            ...
            {personID && anotherLoaded && anotherProfile && (
              <Button
                ...
                color="secondary"
                onClick={() =>
                  history.push(`/admin/users/${anotherProfile.id}`)
                }
              >
                Delete User &nbsp;
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                {usernameHasChanged
                  ? `Username will be changed to ${userName} \n`
                  : ''}
